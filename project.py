...
def roll():   #Rolling function that rolls a dice, goes again if its a six
    ...
    if TURN == True:
        ...
        if rollc == 1:
            ...
            L1 = Label(root, text=dice, fg='Black', background='yellow', font=("Arial", 24, "bold"))
        ...
        if rollc == 2:
            if dice == 6:
                ...
                L3 = Label(root, text=dice1, fg='Black', background='yellow', font=("Arial", 24, "bold"))
        ...
        if rollc == 3:
            if dice1 == 6:
                ...
                L4 = Label(root, text=dice2, fg='Black', background='yellow', font=("Arial", 24, "bold"))
...
def clear():        #clears all the variable prior to next player's turn
    ...
    del rolls[:]
    TURN = True
    L1 = Label(root, text="        ", fg='Black', background='yellow', font=("Arial", 24, "bold"))
    L1.place(x=800, y=200)
    L3 = Label(root, text="        ", fg='Black', background='yellow', font=("Arial", 24, "bold"))
    L3.place(x=800, y=250)
    L4 = Label(root, text="        ", fg='Black', background='yellow', font=("Arial", 24, "bold"))
    L4.place(x=800, y=300)
    print("cleared")
    turn()
...
def movecheck(r, rh, rb, la):       #Check if the player can make a move
    ...
    if win == True:                                         #If all gamepieces home, prints that the player has won
        print("YOU HAVE WON")
        L2 = Label(root, text=(la + "Wins"), fg='Black', background='yellow', font=("Arial", 24, "bold"))
